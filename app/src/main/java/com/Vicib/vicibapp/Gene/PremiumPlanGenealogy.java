...
public class PremiumPlanGenealogy extends AppCompatActivity {
    ...
    TextView username_one,sponsor_userid_one,sponsor_username_one,type_one,leftGBV_one,rightGBV_one,leftcount_one,rightcount_one,leftactive_one,rightactive_one;
...
//        type_one=view.findViewById(R.id.type_one);
...
//        type_two=view.findViewById(R.id.type_two);
