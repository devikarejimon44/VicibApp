package com.Vicib.vicibapp.ui.Dashboard;
...
import com.Vicib.vicibapp.ChangePassword;
...
import com.Vicib.vicibapp.ResponseChangePassword;
...
//  yourView.setBackgroundColor(Color.parseColor("#ffffff"));
        ...
        dash_productstore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ProductStore.class);
