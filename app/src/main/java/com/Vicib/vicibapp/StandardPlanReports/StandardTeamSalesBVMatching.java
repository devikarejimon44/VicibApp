...
public class StandardTeamSalesBVMatching extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView back_silver_teamsalesbvmatching=findViewById(R.id.back_silver_teamsalesbvmatching);
        back_silver_teamsalesbvmatching.setOnClickListener(new View.OnClickListener() {
            @Override
