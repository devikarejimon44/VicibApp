...
import com.Vicib.vicibapp.Complaints.ComplaintStatus;
import com.Vicib.vicibapp.Complaints.ComplaintsRegistration;
import com.Vicib.vicibapp.Gene.StandardPlanGenealogy;
import com.Vicib.vicibapp.Gene.PremiumPlanGenealogy;
import com.Vicib.vicibapp.Gene.SponsorTree;
import com.Vicib.vicibapp.Payout.PayoutLedger;
import com.Vicib.vicibapp.PremiumPlanReports.PremiumLeftSideSales;
import com.Vicib.vicibapp.PremiumPlanReports.PremiumRightSideSales;
import com.Vicib.vicibapp.PremiumPlanReports.PremiumTeamSalesBVMatching;
import com.Vicib.vicibapp.PremiumPlanReports.PremiumTeamSalesBonusDetails;
import com.Vicib.vicibapp.MyProfile.MyProfile;
import com.Vicib.vicibapp.Reports.BasicActiveMembers;
import com.Vicib.vicibapp.Reports.FirstPurchaseBVReport;
import com.Vicib.vicibapp.Reports.LeftSideMembers;
import com.Vicib.vicibapp.Reports.MyProducts;
import com.Vicib.vicibapp.Reports.RightSideMembers;
import com.Vicib.vicibapp.Reports.SponsorsList;
import com.Vicib.vicibapp.RepurchasePlanReports.DownlineRepurchaseDetails;
import com.Vicib.vicibapp.RepurchasePlanReports.RepurchaseBVReports;
import com.Vicib.vicibapp.RepurchasePlanReports.RepurchaseIncome;
import com.Vicib.vicibapp.RepurchasePlanReports.RepurchaseIncomeDetails;
import com.Vicib.vicibapp.StandardPlanReports.StandardLeftSideSales;
import com.Vicib.vicibapp.StandardPlanReports.StandardRightSideSales;
import com.Vicib.vicibapp.StandardPlanReports.StandardTeamSalesBVMatching;
import com.Vicib.vicibapp.StandardPlanReports.StandardTeamSalesBonusDetails;
import com.Vicib.vicibapp.ui.Genealogy.SponsorsDownlineList;
...
//         menu should be considered as top level destinations.
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_sponsorlist, R.id.nav_left_side_member, R.id.nav_right_side_member, R.id.nav_silver_plan_reports, R.id.nav_left_side_sales, R.id.nav_right_side_sales,
    ...
    private void prepareMenuData() {
        ...
        MenuModel childModel = new MenuModel(" Silver Plan Genealogy ", false, false,R.drawable.ic_arrow);
        childModelsList.add(childModel);

        childModel=new MenuModel("Gold Plan Genealogy",false,false,R.drawable.ic_arrow);
        childModelsList.add(childModel);

        childModel = new MenuModel(" Sponsors Tree", false, false,R.drawable.ic_arrow);
        childModelsList.add(childModel);

        childModel=new MenuModel("Sponsors Tabular View", false,false,R.drawable.arrow);
        childModelsList.add(childModel);

        childModel=new MenuModel("Sponsors Downline List", false,false,R.drawable.arrow);
        childModelsList.add(childModel);
        ...
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if(groupPosition==1) {
                    ...
                    Intent Intent = new Intent(getApplicationContext(), ProductStore.class);
                       startActivity(Intent);
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if(groupPosition==2) {
                    ...
                    if (childPosition == 1) {
                        ...
                        Intent Intent = new Intent(getApplicationContext(), StandardPlanGenealogy.class);
                        startActivity(Intent);


                    }
                    if (childPosition == 2) {
                        Intent Intent = new Intent(getApplicationContext(), SponsorTree.class);
                        startActivity(Intent);
                    ...
                    if (childPosition == 4) {
                        Intent Intent = new Intent(getApplicationContext(), SponsorsDownlineList.class);
                        startActivity(Intent);
