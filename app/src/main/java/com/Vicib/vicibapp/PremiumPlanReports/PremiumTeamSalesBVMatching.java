...
public class PremiumTeamSalesBVMatching extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView back_gold_teamsalesbvmatching=findViewById(R.id.back_gold_teamsalesbvmatching);
        back_gold_teamsalesbvmatching.setOnClickListener(new View.OnClickListener() {
            @Override
